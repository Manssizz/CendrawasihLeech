...
async def aria_start():
    ...
    aria2_daemon_start_cmd.append("--peer-id-prefix=-DE13F0-")
    aria2_daemon_start_cmd.append("--user-agent=Deluge 1.3.15")
    aria2_daemon_start_cmd.append("--peer-agent=Deluge 1.3.15")
            ...
            try:
                ...
                if message_to_send != "":
                    ...
                    message_to_send = message_to_send + "\n" + \
                        "#CendrawasihLeech" + mention_req_user
                else:
